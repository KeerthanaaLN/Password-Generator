...
length_label = tk.Label(root, text="Password Length:", background='black', foreground='white')
...
generate_button = tk.Button(root, text="Generate Password", command=generate_password, background='black', foreground='white')
